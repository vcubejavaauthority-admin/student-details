...
public class AuthController {
    ...
    @Value("${google.sheet.auth-master-id}")
    ...
    public String handleLogin(@RequestParam String username, @RequestParam String password,
        ...
        try {
            ...
            ValueRange response = sheetsService.spreadsheets().values()
                    .get(masterSpreadsheetId, range).execute();
    ...
    public Map<String, Object> createUser(@RequestParam String username, @RequestParam String password,
        ...
        try {
            ...
            ValueRange existing = sheetsService.spreadsheets().values()
                    .get(masterSpreadsheetId, readRange).execute();
            ...
            sheetsService.spreadsheets().values()
                    .append(masterSpreadsheetId, ADMINS_SHEET + "!A:D", body)
        ...
        try {
            ...
            if (rows != null) {
                ...
                if (found) {
                    ...
                    sheetsService.spreadsheets().values()
                            .clear(masterSpreadsheetId, range,
                    ...
                    if (!updated.isEmpty()) {
                        ...
                        sheetsService.spreadsheets().values()
                                .update(masterSpreadsheetId, ADMINS_SHEET + "!A2", body)
                                .setValueInputOption("RAW")
                                .execute();
                    }
                    result.put("success", true);
